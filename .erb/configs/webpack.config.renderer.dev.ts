...
const configuration: webpack.Configuration = {
  ...
  entry: {
    loaderWindow: [
      ...
      path.join(webpackPaths.srcRendererPath, 'loaderWindow/index.tsx'),
    ],
    mainWindow: [
      `webpack-dev-server/client?http://localhost:${port}/dist`,
      'webpack/hot/only-dev-server',
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: path.join('loaderWindow/index.html'),
      template: path.join(webpackPaths.srcRendererPath, 'loaderWindow/index.ejs'),
      chunks: ['loaderWindow'],
      minify: {
